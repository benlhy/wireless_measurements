...
/***************************************************************************//**
 * @brief
 * Read the last received byte from UART if the rx flag is set, else return none
 *
 * @return
 * The most recent byte read by the UART or NULL
 *
 ******************************************************************************/
uint8_t UART0_read_if_available(void);
